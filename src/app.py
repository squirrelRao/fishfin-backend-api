...
def add_watch_symbol():
    ...
    for period in periods:
        db.user_strategy.update({"user_id":user_id,"symbol":symbol,"period":period},{"$set":{"user_id":user_id,"period":period,"symbol":symbol,"strategy" : "rsi", "max_sell_rsi" : 20, "min_buy_rsi" : 80}},upsert=True)
    return {"rc":0}
